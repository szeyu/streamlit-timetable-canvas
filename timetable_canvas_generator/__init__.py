...
if not _RELEASE:
    _component_func = components.declare_component(
        # We give the component a simple, descriptive name ("timetable_canvas_generator"
    ...
    _component_func = components.declare_component("timetable_canvas_generator", path=build_dir)
